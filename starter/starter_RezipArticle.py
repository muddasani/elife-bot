...
"""
Amazon SWF RezipArticle starter
"""

class starter_RezipArticle():
  ...
  def start(self, ENV = "dev", doi_id = None):
    ...
    if(doi_id is not None):
      ...
      (workflow_id, workflow_name, workflow_version,
       ...
       input) = self.get_workflow_params(doi_id, settings)
  ...
  def get_workflow_params(self, doi_id, settings):
    ...
    workflow_id = "RezipArticle_" + str(doi_id)

    # workflow_id as set above
    workflow_id = workflow_id
    workflow_name = "RezipArticle"
    workflow_version = "1"
