...
"""
RezipArticle workflow
"""

class workflow_RezipArticle(workflow.workflow):
	...
	def __init__(self, settings, logger, conn = None, token = None, decision = None, maximum_page_size = 100):
		...
		self.version = "1"
		self.description = "Download article files, rename or change them, and then upload them again"
		...
		workflow_definition = {
			...
			[
				...
				{
					"activity_type": "RezipArticle",
					"activity_id": "RezipArticle",
					"version": "1",
					"input": data,
					"control": None,
					"heartbeat_timeout": 60*60,
					"schedule_to_close_timeout": 60*60,
					"schedule_to_start_timeout": 300,
					"start_to_close_timeout": 60*60
				}
			],
